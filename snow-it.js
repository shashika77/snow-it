 ...
 * @params speed - speed of flakes when falling down, 10 by default
 * @params flakeColor - color of snowflake, #FFFFFF by default
 * @example $.fn.snowit({ maxSize: 200, total: 25 });
 */
(function ($) {
	$.fn.snowit = function (options) {
	  var $flake = $('<div class="lis-flake" />').css({
		  'top': '-50px',
		  'position': 'absolute',
